...
if(isset($_POST['submit'])){
   ...
   if (empty($teacher) || empty($section) || empty($course) || empty($course_time)){
      ...
      $update_data = "UPDATE `section a` SET teacher='$teacher', section='$section', course='$course', course_time='$course_time', room='$room'  WHERE id = '$id'";
...
<div class="admin-product-form-container centered">
   ...
   <?php
      ...
      $select = mysqli_query($conn, "SELECT * FROM `section a` WHERE id = '$id'");
